...
saturnApp.controller('RiskCtrl', function($scope, $modalInstance, commitment, Commitment) {
...
saturnApp.controller('DependencyCtrl', function($scope, $modalInstance, commitment, Commitment) {
	$scope.commitment = commitment;
